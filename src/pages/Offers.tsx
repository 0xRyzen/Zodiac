    ...
    <div className="bg-[#F5F5F2] min-h-screen pt-20">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 py-16">
        ...
        <div className="bg-[#E7DFC8] p-12 mb-24 text-center rounded-sm relative overflow-hidden">
          ...
          <div className="mt-8 text-[10px] text-[#121212]/40 uppercase tracking-widest">
            Valid on first-time orders. Excludes bundles.
          </div>
        </div>

        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-8">
          <h3 className="text-3xl font-serif text-[#121212]">Curated Bundles</h3>
          <Link to="/shop" className="text-xs font-bold uppercase tracking-widest text-gray-500 hover:text-[#121212] transition-colors">View All</Link>
        </div>
             ...
             >
                <div className="aspect-[4/5] bg-white relative rounded-sm overflow-hidden mb-6 shadow-sm">
                   <img 
                    ...
                    alt={product.name} 
                   />
                   <div className="absolute top-4 left-4 bg-[#C9A86A] text-[#121212] text-[10px] font-bold px-3 py-1 uppercase tracking-widest">
                     20% Off
                   </div>
                </div>
