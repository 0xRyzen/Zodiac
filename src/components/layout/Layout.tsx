				...
				<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					<div className="grid grid-cols-1 md:grid-cols-4 gap-16 md:gap-8">
						<div className="md:col-span-1">
							...
							<p className="text-gray-400 text-sm leading-relaxed max-w-xs">Intentional botanical wellness for a balanced life. Organically grown, rigorously tested, ethically sourced.</p>
						</div>
						<div>
						...
						<div>
							...
							<ul className="space-y-4 text-sm text-gray-400">
								<li>
									<Link to="/education" className="hover:text-white transition-colors duration-300 block w-max">
										Dosage Guide
									</Link>
								</li>
								<li>
									<Link to="/about" className="hover:text-white transition-colors duration-300 block w-max">
										Our Process
									</Link>
								</li>
								<li>
									<Link to="/legal" className="hover:text-white transition-colors duration-300 block w-max">
										Lab Results
									</Link>
								</li>
							</ul>
					...
					<div className="mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600">
						<p>&copy; 2026 Zodiac Wellness. All rights reserved.</p>
						<div className="flex gap-6 mt-4 md:mt-0">
							<Link to="/legal" className="hover:text-gray-400">
								Privacy Policy
							</Link>
							<Link to="/legal" className="hover:text-gray-400">
								Terms of Service
